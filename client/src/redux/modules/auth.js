...
const PATCH_USER_START = `${userPrefix}/START`;
const PATCH_USER_SUCCESS = `${userPrefix}/SUCCESS`;
const PATCH_USER_FAIL = `${userPrefix}/FAIL`;
...
//  saga reducer - Update the user info
